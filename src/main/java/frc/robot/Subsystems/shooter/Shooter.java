...
public class Shooter extends SubsystemBase {
    ...
    public Command activateShooter(double distance) {
    double RPS = SmartDashboard.getNumber("Shooter Speed", distance * 10); // Example: Speed increases with distance

    return runShooterVelocity(RPS);
    }
